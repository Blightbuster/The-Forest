		...
		try
		{
			...
			else
			{
				...
				if (other.gameObject.CompareTag("PlayerNet") && (this.mainTrigger || (!this.mainTrigger && (this.animControl.smashBool || this.chainSaw))))
				{
					...
					if (!object.ReferenceEquals(component3, component4))
					{
				...
				else
				{
					...
					if (other.gameObject.CompareTag("structure") && !this.repairTool)
					{
					...
					if (this.spear && other.gameObject.CompareTag("Fish") && (this.MyFish == null || !this.MyFish.gameObject.activeSelf) && !this.mainTrigger)
					{
					...
					if (other.gameObject.CompareTag("hanging") || other.gameObject.CompareTag("corpseProp") || (other.gameObject.CompareTag("BreakableWood") && !this.mainTrigger))
					{
						...
						if (component5)
						{
							component5.AddForceAtPosition(this.playerTr.forward * d * 0.75f * (0.016666f / Time.fixedDeltaTime), base.transform.position, ForceMode.Force);
						}
					...
					mutantHitReceiver component6 = other.GetComponent<mutantHitReceiver>();
					if ((other.gameObject.CompareTag("enemyCollide") || other.gameObject.CompareTag("animalCollide")) && this.mainTrigger && !this.enemyDelay && !this.animControl.smashBool)
					{
						...
						if (this.hitReactions.kingHitBool || this.fsmHeavyAttackBool.Value)
						{
							if (component6)
							{
								...
								{
									component6.sendHitFallDown(num4 * 3f);
									if (playerHitEnemy != null)
									{
										playerHitEnemy.Hit = (int)num4 * 3;
								...
								else
								{
									...
									component6.hitRelay((int)num4 * 3);
								}
							}
							else
							{
								int animalHitDirection = animalHealth.GetAnimalHitDirection(num3);
								...
								other.transform.SendMessageUpwards("Hit", (int)num4 * 3, SendMessageOptions.DontRequireReceiver);
								if (playerHitEnemy != null)
								{
						...
						else
						{
							if (component6)
							{
								component6.hitRelay((int)num4);
							}
							else
							{
								int animalHitDirection2 = animalHealth.GetAnimalHitDirection(num3);
						...
						else if (!this.hitReactions.kingHitBool)
						{
							if (component6)
							{
								component6.getCombo(this.animControl.combo);
							}
							else
							{
					...
					if ((other.CompareTag("suitCase") || other.CompareTag("metalProp")) && this.animControl.smashBool)
					{
						...
						if (other.CompareTag("metalProp"))
						{
							...
							if (component7)
							{
								component7.AddForceAtPosition((Vector3.down + LocalPlayer.Transform.forward * 0.2f) * this.pushForce * 2f * (0.016666f / Time.fixedDeltaTime), base.transform.position, ForceMode.Force);
							}
						}
					}
					if ((other.CompareTag("enemyCollide") || other.CompareTag("lb_bird") || other.CompareTag("animalCollide") || other.CompareTag("Fish") || other.CompareTag("EnemyBodyPart")) && !this.mainTrigger && !this.enemyDelay && (this.animControl.smashBool || this.chainSaw))
					{
						...
						other.transform.SendMessage("getSkinHitPosition", base.transform, SendMessageOptions.DontRequireReceiver);
						other.transform.SendMessage("hitSuitCase", num5, SendMessageOptions.DontRequireReceiver);
						other.gameObject.SendMessage("getAttacker", this.Player, SendMessageOptions.DontRequireReceiver);
						other.gameObject.SendMessage("getAttackerType", 4, SendMessageOptions.DontRequireReceiver);
						...
						else if (!other.gameObject.CompareTag("Fish"))
						{
							...
							{
								Vector3 vector3 = other.transform.root.GetChild(0).InverseTransformPoint(this.playerTr.position);
								float targetAngle = Mathf.Atan2(vector3.x, vector3.z) * 57.29578f;
								...
								other.transform.SendMessageUpwards("Hit", (int)num5, SendMessageOptions.DontRequireReceiver);
								Mood.HitRumble();
								if (playerHitEnemy != null)
								{
							...
							{
								other.transform.SendMessageUpwards("getAttackDirection", 3, SendMessageOptions.DontRequireReceiver);
								other.transform.SendMessageUpwards("Hit", num5, SendMessageOptions.DontRequireReceiver);
								Mood.HitRumble();
							}
						}
						else if (other.gameObject.CompareTag("Fish") && !this.spear)
						{
							other.transform.SendMessage("Hit", num5, SendMessageOptions.DontRequireReceiver);
							Mood.HitRumble();
						}
						if (playerHitEnemy != null)
						{
							playerHitEnemy.getAttackerType = 4;
							playerHitEnemy.Hit = (int)num5;
						}
						if (this.axe)
						{
