...
namespace AFSTouchGrass
{
	...
	public class AfsDisplacementRenderer : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			this.ShaderPropID = Shader.PropertyToID("_OverallPower");
		}
		...
		private void Update()
		{
			...
			this.m_TrailRendererMat.SetFloat(this.ShaderPropID, this.m_outputImpulse);
			...
			{
				this.m_MeshRendererMat.SetFloat(this.ShaderPropID, this.m_outputIdleImpulse);
			}
		}
