...
namespace ChromaSDK.ChromaPackage.Model
{
	...
	[DataContract]
	public class EffectIdentifierResponseResults : IEquatable<EffectIdentifierResponseResults>
	{
		
		public EffectIdentifierResponseResults(int? Result = null)
		{
			this.Result = Result;
		}
		...
		public override string ToString()
		{
			...
			stringBuilder.Append("class EffectIdentifierResponseResults {\n");
