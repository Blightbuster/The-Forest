...
namespace Ceto
{
	...
	public class RefractionCommand : IRefractionCommand
	{
		...
		private RefractionCommand.Command CopyScreenCmd { get; set; }

		
		
		
		private RefractionCommand.Command CopyDepthCmd { get; set; }

		
		
		
		private RefractionCommand.Command NormalFadeCmd { get; set; }
