...
namespace Pathfinding.Serialization
{
	...
	public class TinyJsonDeserializer
	{
		...
		private object Deserialize(Type tp, object populate = null)
		{
			...
			{
				return float.Parse(this.EatField());
			}
			...
			if (object.Equals(tp, typeof(Vector2)))
			{
				...
				this.EatField();
				vector.x = float.Parse(this.EatField());
				this.EatField();
				vector.y = float.Parse(this.EatField());
				this.Eat("}");
				return vector;
			}
			if (object.Equals(tp, typeof(Vector3)))
			{
				...
				this.EatField();
				vector2.x = float.Parse(this.EatField());
				this.EatField();
				vector2.y = float.Parse(this.EatField());
				this.EatField();
				vector2.z = float.Parse(this.EatField());
				this.Eat("}");
				return vector2;
			}
