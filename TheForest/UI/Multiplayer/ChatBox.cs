...
namespace TheForest.UI.Multiplayer
{
	...
	public class ChatBox : MonoBehaviour
	{
		...
		{
			this.ToggleInput(!ChatBox.IsChatOpen);
		}

		
		private void ToggleInput(bool onoff)
		{
			TheForest.Utils.Input.player.controllers.maps.SetMapsEnabled(!onoff, ControllerType.Keyboard, "Chat");
			TheForest.Utils.Input.player.controllers.maps.SetMapsEnabled(onoff, ControllerType.Keyboard, "Default");
			TheForest.Utils.Input.player.controllers.maps.SetMapsEnabled(!onoff, ControllerType.Joystick, "Chat");
			TheForest.Utils.Input.player.controllers.maps.SetMapsEnabled(onoff, ControllerType.Joystick, "Default");
		}
