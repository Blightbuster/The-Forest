...
namespace TheForest.Buildings.Creation
{
	...
	[AddComponentMenu("Buildings/Creation/Wall Defensive Architect")]
	...
	public class WallDefensiveArchitect : WallArchitect
	{
		...
		private void Start()
		{
			...
			this._canPlayerToggleAutofillmode = false;
		...
		protected override void ShowTempWall()
		{
			...
			else if (this._multiPointsPositions.Count > 1)
			{
				vector2 = MathEx.TryAngleSnap(base.transform.position, this._multiPointsPositions[this._multiPointsPositions.Count - 1], this._multiPointsPositions[this._multiPointsPositions.Count - 2], PlayerPreferences.BuildingSnapAngle, PlayerPreferences.BuildingSnapRange, true);
		...
		protected override ConstructionIcons ConstructionIcons
		{
			get
			{
				return Scene.HudGui.DefensiveWallConstructionIcons;
			}
		}
	}
}
