	...
	public class Create : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			else if (this.CreateMode)
			{
				...
				if ((!TheForest.Utils.Input.IsGamePad) ? TheForest.Utils.Input.GetButtonDown("Esc") : TheForest.Utils.Input.GetButtonDown("Drop"))
				{
					this.CancelPlace();
				}
		...
		public void OpenBook()
		{
			...
			if (LocalPlayer.AnimControl.onRope || LocalPlayer.AnimControl.useRootMotion || LocalPlayer.AnimControl.onRockThrower || LocalPlayer.Animator.GetBool("logHeld") || LocalPlayer.AnimControl.carry)
			{
				this.ShouldOpenBook = false;
				this.CloseTheBook(false);
				return;
		...
		public void InitPlacer(BuildingBlueprint bp)
		{
			...
			this._buildingPlacer = this.BuildingPlacerCloseMedFar[(int)bp._placerDistance];
