...
public class CoopPlayerCallbacks : GlobalEventListener
{
	...
	public override void Disconnected(BoltConnection connection)
	{
		...
		if (BoltNetwork.isClient && CoopClientCallbacks.OnDisconnected == null && !CoopSteamClientStarter.Retrying)
		{
			...
			if ((LocalPlayer.Inventory == null || (LocalPlayer.Inventory.CurrentView != PlayerInventory.PlayerViews.EndCrash && LocalPlayer.Inventory.CurrentView != PlayerInventory.PlayerViews.EndDeactivate)) && !Application.loadedLevelName.ToLower().Contains("epilogue"))
			{
