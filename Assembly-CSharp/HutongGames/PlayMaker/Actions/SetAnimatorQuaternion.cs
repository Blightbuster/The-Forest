...
namespace HutongGames.PlayMaker.Actions
{
	...
	[HelpUrl("https://hutonggames.fogbugz.com/default.asp?W1073")]
	public class SetAnimatorQuaternion : FsmStateAction
	{
		...
		private void SetParameter()
		{
			if (this._animator != null)
			{
				this._animator.SetQuaternion(this._paramID, this.Value.Value);
			}
		}
		...
		[Tooltip("The Quaternion value to assign to the animator parameter")]
