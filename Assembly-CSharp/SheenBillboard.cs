...
public class SheenBillboard : MonoBehaviour, IThreadSafeTask
{
	...
	public virtual void OnEnable()
	{
		...
		{
			ActionIcon actionIcon = ActionIconSystem.RegisterIcon(base.transform, this._action, this._sideIcon, ActionIconSystem.CurrentViewOptions.AllowInWorld, false, true, this._vrIconCache, this.ActionTextOverride, this.UseFillSprite);
			if (actionIcon)
			{
	...
	public string ActionTextOverride = "USE";
