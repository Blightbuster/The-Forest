...
public class SurvivalBook : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		TheForest.Utils.Input.SetState(InputState.Book, true);
	}
	...
	private void OnDisable()
	{
		...
		TheForest.Utils.Input.SetState(InputState.Book, false);
	}

	private void Update()
	{
		if (LocalPlayer.Inventory && LocalPlayer.Inventory.CurrentView == PlayerInventory.PlayerViews.Book && (LocalPlayer.Animator.GetBool("lighterHeld") || LocalPlayer.Animator.GetBool("flashLightHeld")))
		{
			LocalPlayer.SpecialItems.SendMessage("StashLighter");
		}
		if (TheForest.Utils.Input.IsGamePad && TheForest.Utils.Input.GetButtonDown("Drop") && !ForestVR.Enabled)
		{
