...
public class EnemyHealth : EntityBehaviour
{
	...
	private void Update()
	{
		...
		if (this.setup.typeSetup.bossBaby && Time.time - this.timeSinceSpawn > 300f)
		{
			this.Die();
		}
