...
public class CoopPlayerVariation
{
	...
	private void ApplyCleanSkin(bool cold)
	{
		...
		if (this.ArmsVR)
		{
			this.ArmsVR.sharedMaterial = this.MaterialArmsClean;
			this.SetArmSkinBlood(this._armBloodVal);
		}
		if (this.Hands)
		{
	...
	private void ApplyMudSkin(bool cold)
	{
		...
		if (this.ArmsVR)
		{
			this.ArmsVR.sharedMaterial = this.MaterialArmsMuddy;
		}
		if (this.Hands)
		{
	...
	private void ApplyBloodSkin(bool cold)
	{
		...
		if (this.ArmsVR)
		{
			this.ArmsVR.sharedMaterial = this.MaterialArmsBloody;
			this._armBloodVal = 0.5f;
			this.SetArmSkinBlood(this._armBloodVal);
		}
		if (this.Hands)
	...
	private void ApplyRedSkin(bool cold)
	{
		...
		if (this.ArmsVR)
		{
			this.ArmsVR.sharedMaterial = this.MaterialArmsRed;
		}
		if (this.Hands)
		{
	...
	private void UpdateSkinColor(bool cold)
	{
		...
		if (this.ArmsVR)
		{
			this.ArmsVR.GetPropertyBlock(this._armsColorBlock);
			this._armsColorBlock.SetColor(this._colorPropertyId, this._lerpSkinColor);
			this.ArmsVR.SetPropertyBlock(this._armsColorBlock);
		}
		if (this.Hands)
		{
	...
	public void SetArmSkinBlood(float amount)
	{
		...
		if (this.ArmsVR != null)
		{
			this.ArmsVR.GetPropertyBlock(this._armsBloodBlock);
			this._armsBloodBlock.SetFloat("_Damage1", amount);
			this._armsBloodBlock.SetFloat("_Damage2", amount);
			this._armsBloodBlock.SetFloat("_Damage3", amount);
			this._armsBloodBlock.SetFloat("_Damage4", amount);
			this.ArmsVR.SetPropertyBlock(this._armsBloodBlock);
		}
	}
	...
	public SkinnedMeshRenderer ArmsVR;
