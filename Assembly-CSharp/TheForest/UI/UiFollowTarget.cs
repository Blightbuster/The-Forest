	...
	public class UiFollowTarget : MonoBehaviour
	{
		private void LateUpdate()
		{
			if (this._target)
			{
				...
				if (position.z > 0f)
				{
					if (ForestVR.Enabled && this._worldFollowVR)
					{
						this._worldFollowVR._uiFollow = this;
					}
					else if (this._inBook)
					{
				...
				else if (ForestVR.Enabled && this._worldFollowVR)
				{
					this._worldFollowVR._uiFollow = null;
				}
				else
				{
		...
		public UiFollowTargetWorld _worldFollowVR;
