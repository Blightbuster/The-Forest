...
namespace TheForest.Graphics
{
	...
	[AddComponentMenu("The Forest/Graphics/WaterEngine")]
	public class WaterEngine : MonoBehaviour
	{
		...
		private void OnRenderImage(RenderTexture source, RenderTexture destination)
		{
			...
			if (Scene.Atmosphere && !Mathf.Approximately(Scene.Atmosphere.FogStartDistance, b))
			{
				Scene.Atmosphere.FogStartDistance = Mathf.Lerp(Scene.Atmosphere.FogStartDistance, b, Time.deltaTime * 2f);
			}
		}
