...
namespace TheForest.Items.Inventory
{
	...
	public class ActiveBonusListener : MonoBehaviour
	{
		private void Awake()
		{
			...
			if (this._heldItemIdentifier != null)
			{
				this._heldItemIdentifier.Properties.ActiveBonusChanged += this.OnActiveBonusChanged;
			}
		}
		...
		private void OnEnable()
		{
			...
			if (this._heldItemIdentifier != null)
			{
				this.OnActiveBonusChanged(this._heldItemIdentifier.Properties.ActiveBonus);
			}
		}
		...
		private void OnDestroy()
		{
			...
			if (this._heldItemIdentifier != null && this._heldItemIdentifier.Properties != null)
			{
				this._heldItemIdentifier.Properties.ActiveBonusChanged -= this.OnActiveBonusChanged;
			}
		}
		...
		public HeldItemIdentifier _heldItemIdentifier;
