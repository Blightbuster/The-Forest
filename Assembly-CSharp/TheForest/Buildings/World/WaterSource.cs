...
namespace TheForest.Buildings.World
{
	...
	public class WaterSource : EntityBehaviour<IWaterSourceState>
	{
		...
		private void CheckTerrainBlocking()
		{
			...
			{
				moveableIconPos = LocalPlayer.MainCamTr.position + LocalPlayer.MainCamTr.forward * 3f + Vector3.down;
			}
		...
		{
			if (LocalPlayer.Transform == null || !this._canRepositionIcon)
			{
				return;
			}
			if (this.AtLake)
			...
			this._canRepositionIcon = !ForestVR.Enabled;
		}
		...
		private bool _canRepositionIcon;
