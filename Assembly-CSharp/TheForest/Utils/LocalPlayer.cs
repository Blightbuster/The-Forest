...
namespace TheForest.Utils
{
	public class LocalPlayer : MonoBehaviour, ILocalPlayer
	{
		...
		public static bool IsInPauseMenu
		{
			get
			{
				return LocalPlayer.CurrentView == PlayerInventory.PlayerViews.Pause;
			}
		}
		...
		private void Awake()
		{
			...
			LocalPlayer.WatchTrVR = this._watchTrVR;
			...
			LocalPlayer.FakeCaveVR = this._fakeCaveVR;
		...
		public static Transform FakeCaveVR;
