...
public class LOD_Settings
{
	...
	public void Update(float quality, float stipplingMult)
	{
		...
		if (flag)
		{
			num5 = Mathf.Min(Mathf.Max(num4 - num3, 0f) * 0.75f * stipplingMult, 35f);
			num6 = num4 - num5 * 0.3f;
		}
		else
		{
			num5 = Mathf.Min(Mathf.Max(num3 - num2, 0f) * 0.75f * stipplingMult, 35f);
			num6 = num3 - num5 * 0.2f;
		}
