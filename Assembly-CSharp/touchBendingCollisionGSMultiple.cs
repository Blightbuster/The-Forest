...
public class touchBendingCollisionGSMultiple : MonoBehaviour
{
	...
	{
		this.OnDespawnedProxy();
	}

	private void OnSpawnedProxy()
	{
		if (this.TouchMaterialBlock == null)
		{
	...
	{
		return col.gameObject.CompareTag("Target") || col.gameObject.CompareTag("Multisled") || col.gameObject.CompareTag("SLTier1") || col.gameObject.CompareTag("SLTier2") || col.gameObject.CompareTag("SLTier3") || col.gameObject.CompareTag("structure");
	}
	...
	public MaterialPropertyBlock TouchMaterialBlock;
