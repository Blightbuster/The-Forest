...
namespace Pathfinding
{
	...
	public class NavMeshGraph : NavGraph, INavmesh, IUpdatableGraph, INavmeshHolder, IRaycastableGraph
	{
		...
		{
			NNInfoInternal nearestForceBoth = NavMeshGraph.GetNearestForceBoth(graph, navmesh, position, constraint, accurateNearestNode);
		...
		{
			this.ScanInternal(delegate(Progress p)
			{
			});
			yield break;
		}
