...
public class AfsGrassDisplacementController : MonoBehaviour
{
	...
	private void CreateComponents()
	{
		...
		this.ATGDisplacementPosPID = Shader.PropertyToID("_ATGDisplacementPos");
		this.AfsGrassTerrainDisplacementTexSizePID = Shader.PropertyToID("_AfsGrassTerrainDisplacementTexSize");
		this.AfsGrassDisplacementTexPosPID = Shader.PropertyToID("_AfsGrassDisplacementTexPos");
		this.AfsGrassDisplacementTexPID = Shader.PropertyToID("_AfsGrassDisplacementTex");
	}
	...
	private void Update()
	{
		...
		this.terrainSizeOverTexturesize = new Vector2(this.TerrainSizeX / this.DisplacementTexCoverage, this.TerrainSizeZ / this.DisplacementTexCoverage);
		Shader.SetGlobalVector(this.AfsGrassTerrainDisplacementTexSizePID, new Vector4(this.TerrainSizeX, this.TerrainSizeZ, this.terrainSizeOverTexturesize.x, this.terrainSizeOverTexturesize.y));
		...
		Shader.SetGlobalVector(this.AfsGrassDisplacementTexPosPID, this.DisplacementTexOrigin);
		Shader.SetGlobalTexture(this.AfsGrassDisplacementTexPID, this.DisplacementTexture);
	...
	private int ATGDisplacementPosPID;

	private int AfsGrassTerrainDisplacementTexSizePID;

	private int AfsGrassDisplacementTexPosPID;

	private int AfsGrassDisplacementTexPID;
