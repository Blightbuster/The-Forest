...
namespace UnitySampleAssets.Characters.FirstPerson
{
	...
	public class MouseLook
	{
		...
		{
			float y = TheForest.Utils.Input.GetAxis("Mouse X") * this.XSensitivity * (PlayerPreferences.MouseSensitivityX + 0.5f);
			float num = TheForest.Utils.Input.GetAxis("Mouse Y") * this.YSensitivity * (PlayerPreferences.MouseSensitivityX + 0.5f);
